...
Post subscription notifications for WordPress with double opt-in, one-click unsubscribe, and digest delivery.
...
- subscriber management in wp-admin
- configurable mail transport and preview mails
- block-based email template editing
...
Yes. The plugin includes an email template editor using blocks.
